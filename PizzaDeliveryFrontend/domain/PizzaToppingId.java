...
public class PizzaToppingId implements Serializable {
    ...
    private za.ac.cput.PizzaDeliveryFrontend.domain.Pizza pizzaId;
    ...
    public PizzaToppingId(za.ac.cput.PizzaDeliveryFrontend.domain.Pizza pizzaId, Topping toppingId) {
